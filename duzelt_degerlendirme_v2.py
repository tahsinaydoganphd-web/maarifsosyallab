...
if os.path.exists(html_path):
    ...
    if eski_kod in html:
        ...
        print("ℹ️ seyret_bul.html zaten düzeltilmiş (veya kod bulunamadı).")
...
def api_seyret_bul_degerlendir():
    try:
        ...
        import json
        import re
        # Regex patternindeki hatayi onlemek icin raw string kullanildi
...
"""
    ...
    if "/api/seyret-bul/degerlendir" not in app_content:
        ...
        if "if __name__ == '__main__':" in app_content:
            # HATA BURADAYDI: 'new=' KALDIRILDI, ARTIK DUZGUN CALISACAK
            app_content = app_content.replace("if __name__ == '__main__':", yeni_rota + "\n\nif __name__ == '__main__':")
